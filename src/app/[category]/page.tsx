  ...
  return (
    <>
      ...
      <div className="container">
        {/* Sorting */}
        <div className="flex justify-end items-center mb-4 gap-2 text-xl">
          ...
          <h3>{selectedSortMethod}</h3>
        </div>
        {/* Results count */}
        <p className="text-end text-[#464646] mb-8">{"2050"} Result</p>
        <div className="grid grid-cols-4 gap-4">
          {/* Filters */}
          <div className="col-span-1 bg-brightPink p-9 rounded-lg self-start sticky top-0">
            <h3 className="text-2xl font-semibold">Filter</h3>
            <div className="mt-6">
              <h4 className="text-xl font-medium mb-4">Color</h4>
            ...
            <div className="mt-6">
              <h4 className="text-xl font-medium mb-4">Size</h4>
            ...
            <div className="mt-6">
              <h4 className="text-xl font-medium mb-4">Brand</h4>
              <div className="flex flex-col gap-4 flex-wrap">
                {brands.map((brand) => (
                  <div
                    key={Math.random()}
            ...
            <div className="mt-6">
              <h4 className="text-xl font-medium mb-4">Price Range</h4>
              <DualRangeSlider
                label={(value) => (
                  <span className="text-nowrap">{value} LE</span>
                )}
                value={values}
            ...
            <div className="flex justify-between mt-16">
              <Button
                variant="outline"
                className="bg-transparent border-pink text-pink"
              >
                Clear
              </Button>
              <Button className="bg-pink">Apply</Button>
            </div>
          </div>
          {/* Products section */}
